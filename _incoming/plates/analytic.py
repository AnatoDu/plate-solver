...
1. **Изгиб круглой пластины** (теория Кирхгофа) — переиспользуем готовые и
   протестированные формулы из ``plate_solver.analytic.circular`` (НЕ копируем):
...
# Reuse: точные формулы изгиба круглой пластины.
from plate_solver.analytic.circular import (  # noqa: F401  (re-export)
    clamped_uniform,
