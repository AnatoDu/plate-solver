...
| Что значит `w_top`/`w_bot`/`dh` в fields.npz | прогибы лицевых поверхностей и изменение толщины dh = w_bot − w_top (при theory=ktn — по NOTES §21; classic — совпадают с w) |
