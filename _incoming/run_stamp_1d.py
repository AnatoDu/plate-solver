#!/usr/bin/env python3
r"""run_stamp_1d.py — 1D контактная задача со ШТАМПОМ → подраздел 4.3 доклада (задел к 2D).
...
Расчётная часть переиспользует ``plate_solver.contact.mor1d`` через ``plates.stamp``.
"""
