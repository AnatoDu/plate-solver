"""Детерминизм эталонного прогона (F5.4): повторный прогон ≡ закоммиченному.
...
def test_reference_rerun_identical(tmp_path):
    committed = (_ROOT / "results" / "reference" / "reference_v0.3.md"
                 ).read_bytes()
    ...
    try:
        ...
        regenerated = (ref_dir / "reference_v0.3.md").read_bytes()
    finally:
    ...
    assert regenerated == committed, (
        ...
        "рассинхрон с закоммиченным reference_v0.3.md")
