"""golden_config.py — единый конфиг «золотой» эталонной серии.

Все числа и рисунки серии выходят из ОДНОГО набора параметров.
Круг считается при h=1.0 (см. свойство D); вся L-серия (w_free,
верификация, контакт, КТН) — при единой толщине h_ktn, чтобы
