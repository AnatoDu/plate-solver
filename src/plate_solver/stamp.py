...
переиспользуют решатель ``plate_solver.mor1d`` (функция Грина балочного
...
from .green1d import green_matrix
...
def solve_stamp(
    ...
    *,
    ...
    Алгоритм ТОЖДЕСТВЕН ``fix_base2.py`` / ``plate_solver.mor1d`` (та же
