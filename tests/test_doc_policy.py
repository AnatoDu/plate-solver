...
явным перечнем: golden-семейство до его переноса в private/legacy
и исторические примечания CHANGELOG. Научная библиография на
...
WHITELIST = {
    "golden_results.md",
    "results/golden/golden_results.md",
    "scripts/run_golden.py",
    "tests/test_golden_hash.py",
