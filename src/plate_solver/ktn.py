...
class KTNParams:
    ...
    def contact_displacement(self, w, lap_w, q0, r) -> np.ndarray:
        ...
        КАНОН ПАКЕТА (решение автора, NOTES §21.1); первоисточник — 1D-теория
        школы. Классическое 3D-восстановление — независимая диагностика
        (§21.2): кривизный блок тождественен (поверхность и знаки
        подтверждены), q,r-члены различаются в пределах O(h²)-точности
        теории. Синоним: :meth:`w_face_bottom`.
        """
