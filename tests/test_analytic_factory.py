"""Фабрика аналитических эталонов: сертификаты, тождества, ограда.

Самосертификация: эталон существует только с проверенным
сертификатом (PDE + КУ; ряды — контроль остатка). Согласование
с ручными функциями на пересечении областей действия (1e-12).
Новые ladder-ступени (big) и отказы резолвера вне ограды.
"""
...
# --------------------------------------------------------------------------- #
#  Тождества с ручными решениями (1e-12)
# --------------------------------------------------------------------------- #
...
# --------------------------------------------------------------------------- #
#  Самосертификация и новое покрытие
# --------------------------------------------------------------------------- #
...
# --------------------------------------------------------------------------- #
#  Ladder-ступени нового покрытия (боевые параметры)
# --------------------------------------------------------------------------- #
@pytest.mark.big
...
def test_contact_reference_vs_mor_gates():
    """Ворота: МОР против замкнутого эталона — w_max и полная сила.
